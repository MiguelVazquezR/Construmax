...
export default {
    ...
    methods: {
        ...
        async getNotifications() {
            this.loading = true;
            try {
                const response = await axios.post(route('users.get-user-notifications'), { module: this.module });
        ...
        async markNotificationsAsRead() {
            try {
                const response = await axios.post(route('users.read-user-notifications'), { notifications_ids: this.selectedNotifications });
        ...
        async deleteNotifications() {
            try {
                const response = await axios.post(route('users.delete-user-notifications'), { notifications_ids: this.selectedNotifications });
