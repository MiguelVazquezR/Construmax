...
class ClientMonitorResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        if ($this->opportunity) {
            $folio = 'S-' . strtoupper(substr($this->opportunity?->name, 0, 3)) . '-' . strtoupper(substr($this->type, 0, 1)) . str_pad($this->id, 4, '0', STR_PAD_LEFT);
        } else {
        ...
        return [
            ...
            'meetingMonitor' => $this->whenLoaded('meetingMonitor'),
