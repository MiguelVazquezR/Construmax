...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="border-b border-gray-300 mb-12 text-center w-[80%] mx-auto">
            <span class="inline-block border-b-2 border-[#FD8827] px-3 text-gray-600">Iniciar sesión</span>
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 relative">
                <div class="flex justify-center items-center">
                    <TextInput id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'"
                        class="mt-1 block w-full bg-transparent placeholder:text-[#97989A]" required
            ...
            <div class="block mt-4">
                <label class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-[#97989A]">No cerrar sesión</span>
                </label>
            </div>

            <div class="flex flex-col items-center justify-center mt-4 space-y-4">
                <Link v-if="canResetPassword" :href="route('password.request')"
                    class="underline text-sm text-[#97989A] hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
