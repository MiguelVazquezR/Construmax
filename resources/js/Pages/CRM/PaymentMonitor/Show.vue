<template>
  <AppLayout title="Seguimiento de pagos">
    ...
    <div class="flex justify-between items-center">
      <span></span>
      <div class="mx-4 my-5">
        <Link v-if="this.$page.props.auth.user.permissions.includes('Registrar pagos en seguimiento integral')"
          :href="route('crm.payment-monitors.create')">
    ...
    <div v-if="currentTab == 1" class="md:grid grid-cols-2 border-b-2 border-[#cccccc] text-sm">
      <div class="grid grid-cols-2 text-left p-4 md:ml-10 border-r-2 border-gray-[#cccccc] items-center">
        ...
        <a class="hover:underline text-primary"
          :href="route('crm.opportunities.show', payment_monitor.data.opportunity?.id)">
        ...
        <a class="hover:underline text-primary"
          :href="route('users.show', payment_monitor.data.seller?.id)">
      ...
      <div class="grid grid-cols-2 text-left p-4 md:ml-10 items-center">
        ...
        <a class="hover:underline text-primary"
          :href="route('crm.customers.show', payment_monitor.data.customer?.id)">
        ...
        <span>{{ payment_monitor.data.contact?.name }}</span>
        <span class="text-gray-500 my-2">Teléfono del contacto</span>
        <span>{{ payment_monitor.data.contact?.phone }}</span>
